...
import AdminDetailRuleScreen from './AdminDetailRuleScreen';
const AdminListRuleScreen = () => {
            ...
            <Box mt="20px">
                <Grid templateColumns="repeat(8, 1fr)">
                    ...
                    <GridItem colSpan={{ base: 8, lg: 6, xl: 6 }}>
                        <AdminDetailRuleScreen ruleq={rulerule} nameq={rulename} show={show} setpq={setq} setpv={setv} ruleid={rid} />
                    </GridItem>
                </Grid>
            </Box>
        </>
...
export default AdminListRuleScreen;