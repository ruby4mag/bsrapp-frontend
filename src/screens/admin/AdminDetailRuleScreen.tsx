...
const AdminDetailRuleScreen = ({ ruleq, nameq, show, setpq, setpv, ruleid }) => {
    const queryValue: JsonGroup = { id: QbUtils.uuid(), type: "group" };
    ...
    const handleUpdate = (e) => {
        e.preventDefault();
        axios.post(`https://api.bsrsport.org/api/admin/rules/${ruleid}`, {
            name: name,
            setParam: setp,
            setValue: setv,
    ...
    return (
        <>
            <Box bg={"white"} background={"white"} p="20px" minH={"400px"} overflowY="auto" alignContent={"center"} justifyContent={"center"}>
