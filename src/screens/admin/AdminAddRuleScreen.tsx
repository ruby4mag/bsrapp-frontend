...
const AdminAddRuleScreen = ({ruleq, nameq , show, setpq,setpv, ruleid}) => {
    const queryValue: JsonGroup = { id: QbUtils.uuid(), type: "group" };
  ...
  const handleUpdate = (e) => {
    e.preventDefault();
    axios.post(`https://api.bsrsport.org/api/admin/rules`, {
        name: name,
        setParam: setp,
        setValue: setv,
  ...
  return (
    <>
   <Box mt="20px" bg={"white"} background={"white"} p="20px" minH={"400px"} overflowY="auto">
...
<Button onClick={handleUpdate}>Add Rule</Button>
...
export default AdminAddRuleScreen;